...
def main():
  bot = telegram.Bot(token='1841009289:AAFAebWPhN6Sns18NCND6RWYZ4Pp_lPzLrg')
  updater = Updater(token='1841009289:AAFAebWPhN6Sns18NCND6RWYZ4Pp_lPzLrg', use_context = True)
